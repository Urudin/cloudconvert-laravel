...
class CloudConvert
{
    ...
    {
        return is_a($this->resource, 'Lingwave\CloudConvertLaravel\Storage');
    }
     ...
     * 
     * @return \Lingwave\CloudConvertLaravel\CloudConvert
     */
    ...
    public function getStorageInstance($provider, $options)
    {
        ...
        $class = "Lingwave\\CloudConvertLaravel\\Storage" . ucfirst($provider);
        $storage = new $class;
    ...
    public function queue($action, $options)
    {
        ...
        \Queue::push('Lingwave\\CloudConvertLaravel\\Queued', compact('action', 'options', 'data'));
        return true;
    }
